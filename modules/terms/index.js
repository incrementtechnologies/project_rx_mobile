...
`}</Text>
       ...
       <Text style={{fontWeight:'bold',paddingTop:10,paddingBottom:5}}>INAPPROPRIATE USE</Text>
       <Text style={{textAlign:'justify'}}>{`You will not upload, display or otherwise provide on or through the Program any content that: (1) is libelous, defamatory, abusive, threatening, harassing, hateful, offensive or otherwise violates any law or infringes upon the right of any third party (including copyright, trademark, privacy, publicity or other personal or proprietary rights); or (2) in Runway Express judgment, is objectionable or which restricts or inhibits any other person from using the Program or which may expose Runway Express or its users to any harm or liability of any kind.`}</Text>

       <Text style={{fontWeight:'bold',paddingTop:10,paddingBottom:5}}>IDEMNIFICATION</Text>
       <Text style={{textAlign:'justify'}}>{`You agree to defend, indemnify and hold harmless Runway Express and its directors, officers, employees, contractors, agents, suppliers, licensors, successors and assigns, from and against any and all losses, claims, causes of action, obligations, liabilities and damages whatsoever, including attorneys’ fees, arising out of or relating to your access or use of the Program, any false representation made to us, your breach of any of these Terms and Conditions, or any claim that any translation we provide to you is inaccurate, inappropriate or defective in any way whatsoever.`}</Text>
       <Text style={{fontWeight:'bold',paddingTop:10,paddingBottom:5}}>DELETING YOUR ACCOUNT</Text>
       <Text style={{textAlign:'justify'}}>{`You can delete your account and terminate your use of the Services at any time by locating the ‘delete profile’ option in the settings section of your Profile. Once you have deleted your Account, your access will be revoked and you will no longer have access to your Profile and we will delete all of the information contained in your Profile. Please be aware that due to technical reasons beyond our control, it might take some time until your personal information disappears completely from search engines (such as Google). We accept no liability for deletion of information or content from your Profile. You acknowledge and accept that certain User Content may remain after the cancellation of your Profile and that the User Content License shall not be revoked or terminated. If you have an active subscription plan when you delete your Account, you will not receive a refund for any time remaining on your subscription.`}</Text>

       <Text style={{fontWeight:'bold',paddingTop:10,paddingBottom:5}}>TERMINATION OF YOUR ACCOUNT BY US</Text>
       <Text style={{textAlign:'justify'}}>{`We reserve the right to modify, temporarily suspend or permanently delete your Account and terminate your access to the Services if we have reason to believe that you have breached or acted inconsistently with the Terms.
